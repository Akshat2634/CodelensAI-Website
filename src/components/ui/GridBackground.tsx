    ...
    <div className={`relative ${className ?? ""}`}>
      ...
      {showOrbs && (
        <>
          <motion.div
            style={{ y: orbY1 }}
            className="pointer-events-none absolute -top-40 -left-40 h-[600px] w-[600px] rounded-full opacity-[0.09]"
          >
            <div
          ...
          <motion.div
            style={{ y: orbY2 }}
            className="pointer-events-none absolute -right-40 -bottom-40 h-[500px] w-[500px] rounded-full opacity-[0.07]"
          >
            <div
              className="h-full w-full rounded-full"
              style={{
